namespace Chiffon.ViewModels
{
    ...
    public class RegisterViewModel
    {
        ...
        [StringLength(50, MinimumLength = 5, ErrorMessage = "Le champs \"Prénom\" doit comporter au moins 5 caractères.")]
        public string Firstname { get; set; }

        [Required(ErrorMessage = "Le champs \"Nom\" est obligatoire.")]
        [StringLength(50, MinimumLength = 5, ErrorMessage = "Le champs \"Nom\" doit comporter au moins 5 caractères.")]
        public string Lastname { get; set; }

        [Required(ErrorMessage = "Le champs \"Agence\" est obligatoire.")]
        [StringLength(100, MinimumLength = 1, ErrorMessage = "Le champs \"Agence\" doit comporter au moins 5 caractères.")]
