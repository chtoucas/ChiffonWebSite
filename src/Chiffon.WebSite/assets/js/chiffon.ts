...
module Chiffon {
  ...
  function setupAjax(timeout: number) {
    $.ajaxSetup({
      timeout: timeout
      , async: true
      , cache: true      
...
this.Chiffon.Views = (function(win: Window, doc: Document, loc: Location, $: JQueryStatic) {
  'use strict';

  var Views: Chiffon.IViews = {
    Layout: null
    , DesignerLayout: null
    , StickyInfo: null
    , HomeIndex: null
...
this.Chiffon.Controllers = (function($: JQueryStatic, Views) {
  'use strict';
