...
namespace Chiffon.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Chiffon.Controllers.HomeController
    {
        ...
        partial void NewsletterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        public override System.Web.Mvc.ActionResult Newsletter()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Newsletter);
            NewsletterOverride(callInfo);
            return callInfo;
        }
