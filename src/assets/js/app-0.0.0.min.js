...
}(this);this.App=function(f,d,g,e){var h={baseUrl:"/assets/js/",debug:!1,domain:"pourquelmotifsimone.com",gaq:"UA-43374044-1",version:e},k=["fr","en"];return function(l){function c(b){return a.baseUrl+b}var a=d.defaults(l||{},h);"/"!==a.baseUrl.substring(-1,1)&&(a.baseUrl+="/");this.dependencies={chiffon:function(){return a.debug?["vendor/l10n-2013.04.18.min.js","localization.js","chiffon.js"].map(c):c("chiffon-"+a.version+".min.js")},googleAnalytics:"//www.google-analytics.com/ga.js",jQuery:function(){return a.baseUrl+
"vendor/"+("__proto__"in{}?"jquery-2.0.3.min.js":"jquery-1.10.2.min.js")},jQueryValidate:function(b){return["jquery.validate.min.js","additional-methods.min.js"].push("localization/messages_"+b+".js").map(function(b){return a.baseUrl+"vendor/"+("jquery.validate-1.11.1/"+b)})}};this.main=function(b,c){var d=this;if(-1===k.indexOf(b))throw Error('The locale "'+b+'" is not supported.');g({test:a.gaq,yep:this.dependencies.googleAnalytics,callback:function(){var b=f.ga;e!==b&&(b("create",a.gaq,a.domain),
b("send","pageview"))}});g({load:[this.dependencies.jQuery()].concat(this.dependencies.chiffon()),complete:function(){var a=f.Chiffon;e!==a&&c(new a({locale:b,app:d}))}})}}}(this,this._,this.yepnope);
