namespace Chiffon.Data
{
    ...
    public class WeakQueryCache : IQueryCache
    {
        ...
        public WeakQueryCache() : this(new HttpContextWrapper(HttpContext.Current)) { }

        public WeakQueryCache(HttpContextBase context)
        {
